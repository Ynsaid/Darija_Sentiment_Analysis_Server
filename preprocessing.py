...
# import project  # import your functions from project.py

# # ----------------------------------------
# # 1️⃣ Load & balance data
# # ----------------------------------------
# train_path = r"C:\Users\Younes\Desktop\M2\Nlp\FASSILA\Data\Sentiment Analysis\train_set.csv"
# val_path   = r"C:\Users\Younes\Desktop\M2\Nlp\FASSILA\Data\Sentiment Analysis\validation_set.csv"
# test_path  = r"C:\Users\Younes\Desktop\M2\Nlp\FASSILA\Data\Sentiment Analysis\test_set.csv"

# df, balanced_df = project.load_and_balance_data(train_path, val_path, test_path)

# # ----------------------------------------
# # 2️⃣ Text cleaning (extended)
# # ----------------------------------------
...
# balanced_df["clean_text"] = balanced_df["text"].apply(clean_text_advanced)

# print("✅ Text cleaned successfully!")
# print(balanced_df.head())

# # ----------------------------------------
# # 3️⃣ Split dataset (train/val/test)
# # ----------------------------------------
...
# # ----------------------------------------
# # 5️⃣ (Optional) Save results for model training
# # ----------------------------------------
# import pickle
...
# print("\n💾 Saved cleaned & tokenized data successfully!")
...
from tensorflow.keras.preprocessing.text import Tokenizer  # type: ignore
from tensorflow.keras.preprocessing.sequence import pad_sequences  # type: ignore
import Project.wordcloud_generator as wordcloud_generator  # import your functions from project.py

# ==========================================================
# 🛑 قائمة كلمات التوقف بالعربية
# ==========================================================
...
# ==========================================================
# 2️⃣ Remove non-Arabic sentences
# ==========================================================
...
after = len(df)
print(f"🧹 Removed {before - after} non-Arabic rows. Remaining: {after}")

# ==========================================================
# 3️⃣ Clean text & remove stopwords (replace in same column)
# ==========================================================
def clean_text_advanced(text):
    text = str(text)
    text = re.sub(r"http\S+|www\S+", "", text)         # remove URLs
...
# فقط نحافظ على text و label
df = df[["text", "label"]]
print("✅ Text cleaned and replaced in same column.")

# ==========================================================
# 4️⃣ Split dataset (train / validation / test)
# ==========================================================
...
# ==========================================================
# 6️⃣ Save cleaned data and tokenizer
# ==========================================================
train_df.to_csv("train_clean.csv", index=False)
val_df.to_csv("val_clean.csv", index=False)
test_df.to_csv("test_clean.csv", index=False)
...
print("\n💾 All cleaned datasets & tokenizer saved successfully!")